...
function createSVG(options = {}) {
    ...
    UnicodeObj = {};
    const dataStr = fs_extra_1.default.readFileSync(process.cwd() + '/db.dat', { encoding: 'utf-8' });
    ...
    return new Promise((resolve, reject) => {
        ...
        fontStream.pipe(fs_extra_1.default.createWriteStream(DIST_PATH))
            ...
            fs_extra_1.default.writeFileSync(process.cwd() + '/db.dat', JSON.stringify(LocalUnicodeObj), { encoding: 'utf-8' });
            resolve(UnicodeObj);
        })
            .on("error", (err) => {
            if (err) {
